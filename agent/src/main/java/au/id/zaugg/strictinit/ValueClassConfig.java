...
public final class ValueClassConfig {
    ...
    boolean isValueClass(String internalName) { return internalName != null && valueClasses.contains(internalName); }
    boolean shouldFinalize(String internalName) { return internalName != null && finalizeClasses.contains(internalName); }
